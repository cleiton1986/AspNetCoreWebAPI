        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisciplinasId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Alunos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Alunos_Disciplinas_DisciplinasId",
            ...
            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "DisciplinasId", "Nome", "SobreNome", "Telefone" },
                values: new object[] { 1, null, "Marta", "Kent", "33225555" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "DisciplinasId", "Nome", "SobreNome", "Telefone" },
                values: new object[] { 2, null, "Paula", "Isabela", "3354288" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "DisciplinasId", "Nome", "SobreNome", "Telefone" },
                values: new object[] { 3, null, "Laura", "Antonia", "55668899" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "DisciplinasId", "Nome", "SobreNome", "Telefone" },
                values: new object[] { 4, null, "Luiza", "Maria", "6565659" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "DisciplinasId", "Nome", "SobreNome", "Telefone" },
                values: new object[] { 5, null, "Lucas", "Machado", "565685415" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "DisciplinasId", "Nome", "SobreNome", "Telefone" },
                values: new object[] { 6, null, "Pedro", "Alvares", "456454545" });

            migrationBuilder.InsertData(
                table: "Alunos",
                columns: new[] { "Id", "DisciplinasId", "Nome", "SobreNome", "Telefone" },
                values: new object[] { 7, null, "Paulo", "José", "9874512" });
